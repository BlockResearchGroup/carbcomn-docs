...
Additional template variants are available for different vault profiles (see [Templates API](/broken/pages/QUZF77P0VixI0JsuqJoY)).
...
> **See also:** [Step 3 — RefBlock & Element Typing](refblock_step.md), [Templates API](/broken/pages/QUZF77P0VixI0JsuqJoY), [Example 200](../04_examples/200_floor_nostag_standard.md)
